$WindowTitle = 'Security Mitigations Prompt - RefinedOS'
...
You can always change this after you have installed RefinedOS, and it is recommended to benchmark the effects of this tweak, if you use it.
...
if ($intButton -eq '6') {
	...
	$mitigationScriptPath = "C:\Users\$loggedInUsername\Desktop\RefinedOS\3. Configuration\1. General Configuration\Mitigations\Disable All Mitigations.cmd"
